...
module.exports = async (prompt) => {
  prompt =
    prompt +
    ", cinematic lighting, highly detailed, intricate, shiny, digital painting, artstation, concept art, smooth, sharp focus, illustration, art by bob kehl and terry morre";
